...
<head>
  <script>
    (function() {{
      ...
      if (!cached) {{
        ...
        window.location.href = "http://{host}:8000/login/index.html";
      }}
    }})();
  </script>
  <meta charset="UTF-8"/>
  ...
  <link rel="stylesheet" href="http://{host}:8000/css/global.css"/>
  <link rel="stylesheet" href="http://{host}:8000/css/web-room.css"/>
  <style>
     .machine-panel {{
...
<nav class="navbar" aria-label="Main navigation">
  <a href="http://{host}:8000/index.html" class="logo">CTF<span>LABS</span></a>
  <div class="nav-links">
    <a href="http://{host}:8000/index.html">Home</a>
    <a href="http://{host}:8000/learn.html">Learn</a>
    <a href="http://{host}:8002/challenges.html">Challenges</a>
    <a href="http://{host}:8000/rules.html">Rules</a>
    <a href="http://{host}:8000/rooms/index.html">Create Room</a>
  ...
  <div class="room-main">
    ...
    <div class="room-body" id="room-body">
      ...
      <div class="completion-card" id="completion-card">
        ...
        <a href="http://{host}:8000/rooms/index.html" class="btn btn-primary">← Back to Manage Rooms</a>
      </div>
    </div>
...
<script src="http://{host}:8000/js/firebase-config.js"></script>
<script src="http://{host}:8000/js/auth-state.js"></script>
</body>
</html>
"""
    return html
