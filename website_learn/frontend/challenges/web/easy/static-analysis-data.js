const LESSONS = [
  {
    ...
    html: `
      ...
      <p>Imagine you are a bomb squad technician who has just found a suspicious device. If you press the buttons or plug it in, it might detonate and destroy the evidence. Instead, you carefully X-ray the device, read the manufacturer labels on the wires, and examine the circuit blueprints without ever turning it on. This allows you to understand exactly how the device is built and what it is designed to do just by looking at its components.</p>
  ...
  },
  {
    ...
    questions: [
      ...
      { q: "Have you successfully completed the static analysis steps in the terminal? (yes/no)", a: "yes" }
    ]
  }
];
